    ...
    <>
      <div className="h-fit flex flex-col md:flex-row gap-16 mt-8">
        ...
        <div className="flex-1 space-y-5">
          <h1 className="text-3xl font-bold tracking-tight">Pan con guayaba y queso</h1>
          ...
          <ul className="space-y-2 ml-7 my-10">
            <li className="text-sm flex items-center gap-2 tracking-tight font-medium">
              ...
              Crema de guayaba de produccion propia
            </li>
          </ul>
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex gap-3">
              <select className="border border-gray-300 rounded-lg px-3 py-1">
                <option value="">Solo guayaba y queso</option>
              </select>
            </div>
          </div>
          ...
          <div className="flex pt-2">
            <div className="flex flex-col gap-1 flex-1 items-center">
              ...
              <p className="text-xs font-semibold">
                Envío gratis para compras mayores a 50$
              </p>
            </div>
